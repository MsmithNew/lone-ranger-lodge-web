    ...
    <Layout>
      ...
      <section className="section-container">
        <div className="max-w-3xl mx-auto">
          <h2 className="section-title text-center">Accessibility Information</h2>
          
          <div className="bg-white p-6 rounded-lg shadow-md mt-6">
            <p className="text-gray-700 mb-4">
              Lone Ranger RV Park & Lodge is committed to ensuring all guests have an enjoyable stay. We've made the following accommodations for guests with mobility or accessibility needs:
            </p>
            
            <div className="space-y-4 mt-6">
              <div>
                <h3 className="font-semibold text-rvmaroon">RV Sites & Cabins</h3>
                <ul className="mt-2 space-y-1 text-gray-700">
                  <li className="flex items-start">
                    <span className="text-rvred mr-2">•</span>
                    ADA-accessible RV sites with paved pads and nearby parking
                  </li>
                  <li className="flex items-start">
                    <span className="text-rvred mr-2">•</span>
                    One fully accessible deluxe cabin with ramp access, roll-in shower, and accessible features
                  </li>
                </ul>
              </div>
              
              <div>
                <h3 className="font-semibold text-rvmaroon">Common Areas</h3>
                <ul className="mt-2 space-y-1 text-gray-700">
                  <li className="flex items-start">
                    <span className="text-rvred mr-2">•</span>
                    Paved pathways to main lodge, office, and common areas
                  </li>
                  <li className="flex items-start">
                    <span className="text-rvred mr-2">•</span>
                    ADA-compliant restroom and shower facilities
                  </li>
                  <li className="flex items-start">
                    <span className="text-rvred mr-2">•</span>
                    Pool area with accessible entry
                  </li>
                  <li className="flex items-start">
                    <span className="text-rvred mr-2">•</span>
                    Accessible parking spaces near all amenities
                  </li>
                </ul>
              </div>
              
              <div>
                <h3 className="font-semibold text-rvmaroon">Additional Information</h3>
                <ul className="mt-2 space-y-1 text-gray-700">
                  <li className="flex items-start">
                    <span className="text-rvred mr-2">•</span>
                  ...
                  <li className="flex items-start">
                    <span className="text-rvred mr-2">•</span>
                    Staff available to assist with specific needs
                  </li>
                  <li className="flex items-start">
                    <span className="text-rvred mr-2">•</span>
                    Accessible transportation can be arranged with advance notice
                  </li>
                </ul>
              </div>
            </div>
            ...
            <p className="mt-6 text-gray-700">
              If you have specific accessibility requirements or questions, please contact us directly at (555) 123-4567 before making your reservation so we can ensure we meet your needs.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-container bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="section-title text-center">Additional Policies</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-display text-rvmaroon mb-3">Weather Policy</h3>
              <p className="text-gray-600">
                Lone Ranger RV Park & Lodge is open year-round. We do not offer refunds for inclement weather, as weather conditions are beyond our control. In the event of severe weather warnings or emergencies, our staff will provide guidance and assistance.
              </p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-display text-rvmaroon mb-3">Group Policy</h3>
              <p className="text-gray-600">
                Groups of 5 or more sites require a group reservation. We offer special rates and designated areas for family reunions, club gatherings, and other groups. Please contact our office for more information on group bookings.
              </p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-display text-rvmaroon mb-3">Extended Stay Policy</h3>
              <p className="text-gray-600">
                For guests staying 30+ nights, we offer special monthly rates. Extended stay guests must complete a separate agreement and provide a security deposit. Monthly stays are subject to site inspection every 30 days.
              </p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-lg font-display text-rvmaroon mb-3">Storage Policy</h3>
              <p className="text-gray-600">
                On-site RV storage is available for a fee when space permits. All stored RVs must be registered and in good condition. Storage is at the owner's risk, and proof of insurance is required.
              </p>
            </div>
          </div>
        </div>
